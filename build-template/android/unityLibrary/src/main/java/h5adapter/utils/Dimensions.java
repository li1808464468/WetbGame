...
public class Dimensions {
    ...
    public static float getDensityRatio() {
        ...
        Resources resources = BFApplication.getContext().getResources();
    ...
    public static int getPhoneHeight(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            if (windowManager != null) {
                ...
                BFLog.v(TAG, "height == " + height + ", w == " + localPoint.x + ", h == " + localPoint.y);
            ...
            BFLog.v(TAG, "Layout h == " + height + ", navigationBarHeight == " + navigationBarHeight);
            if (navigationBarHeight != 0 && height % 10 != 0) {
                if ((height + navigationBarHeight) % 10 == 0) {
                    height = (height + navigationBarHeight);
                }
            }
            BFLog.v(TAG, "height == " + height + ", navigationBarHeight == " + navigationBarHeight);
        }
    ...
    public static boolean isRtl() {
        Resources res = BFApplication.getContext().getResources();
