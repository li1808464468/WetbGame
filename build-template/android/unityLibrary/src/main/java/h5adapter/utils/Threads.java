...
public class Threads {
    ...
    private static final String THREAD_TAG_POOL = "h5-pool-thread-";
    private static final String THREAD_TAG_SERIAL = "h5-serial-thread";
    ...
    public static Object callWithTimeout(Callable<Object> callable, long timeout, TimeUnit unit) throws TimeoutException {
        ...
        try {
            ...
            BFLog.i(TAG, "Invocation timed out, interrupt");
            future.cancel(true);
            throw e;
        }
        return returnValue;
